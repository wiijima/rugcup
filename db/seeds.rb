Country.create(name: 'アイルランド', pool: 'A')
Country.create(name: 'スコットランド', pool: 'A')
Country.create(name: '日本', pool: 'A')
Country.create(name: 'ロシア', pool: 'A')
Country.create(name: '未定１', pool: 'A')
Country.create(name: 'ニュージーランド', pool: 'B')
Country.create(name: '南アフリカ', pool: 'B')
Country.create(name: 'イタリア', pool: 'B')
Country.create(name: '未定２', pool: 'B')
Country.create(name: '未定３', pool: 'B')
Country.create(name: 'イングランド', pool: 'C')
Country.create(name: 'フランス', pool: 'C')
Country.create(name: 'アルゼンチン', pool: 'C')
Country.create(name: 'アメリカ', pool: 'C')
Country.create(name: 'トンガ', pool: 'C')
Country.create(name: 'オーストラリア', pool: 'D')
Country.create(name: 'ウェールズ', pool: 'D')
Country.create(name: 'ジョージア', pool: 'D')
Country.create(name: 'フィジー', pool: 'D')
Country.create(name: 'ウルグアイ', pool: 'D')
Country.create(name: 'poolA１位', pool: '準々決勝')
Country.create(name: 'poolA２位', pool: '準々決勝')
Country.create(name: 'poolB１位', pool: '準々決勝')
Country.create(name: 'poolB２位', pool: '準々決勝')
Country.create(name: 'poolC１位', pool: '準々決勝')
Country.create(name: 'poolC２位', pool: '準々決勝')
Country.create(name: 'poolD１位', pool: '準々決勝')
Country.create(name: 'poolD２位', pool: '準々決勝')
Country.create(name: '準々決勝１勝者', pool: '準決勝')
Country.create(name: '準々決勝２勝者', pool: '準決勝')
Country.create(name: '準々決勝３勝者', pool: '準決勝')
Country.create(name: '準々決勝４勝者', pool: '準決勝')


Venue.create(name: '札幌ドーム', address: '〒062-0045 北海道札幌市豊平区羊ケ丘１', lat: '43.015775', lng: '141.409529')
Venue.create(name: '釜石鵜住居復興スタジアム', address: '〒026-0301 岩手県釜石市鵜住居町', lat: '39.360816', lng: '141.626520')
Venue.create(name: '熊谷ラグビー場', address: '〒360-0004 埼玉県熊谷市上川上８１０', lat: '36.163881', lng: '139.411142')
Venue.create(name: '味の素スタジアム', address: '〒182-0032 東京都調布市西町 西町３７６−３', lat: '35.664270', lng: '139.527151')
Venue.create(name: '横浜国際総合競技場', address: '〒222-0036 神奈川県横浜市港北区小机町３３００', lat: '35.509946', lng: '139.606394')
Venue.create(name: '小笠山総合運動公園エコパスタジアム', address: '〒437-0031 静岡県袋井市愛野２３００−１', lat: '34.743556', lng: '137.970508')
Venue.create(name: '豊田スタジアム', address: '〒471-0016 愛知県豊田市千石町７丁目２', lat: '35.084528', lng: '137.170954')
Venue.create(name: '東大阪市花園ラグビー場', address: '〒578-0923 大阪府東大阪市松原南１丁目１−１−１', lat: '34.668936', lng: '135.626276')
Venue.create(name: '神戸市御崎公園球技場', address: '〒652-0855 兵庫県神戸市兵庫区御崎町１丁目２−２', lat: '34.656702', lng: '135.168998')
Venue.create(name: '東平尾公園博多の森球技場', address: '〒816-0052 福岡県福岡市博多区東平尾公園２−１−１', lat: '33.585894', lng: '130.460795')
Venue.create(name: '熊本県民総合運動公園陸上競技場', address: '〒861-8012 熊本県熊本市東区平山町２７７６', lat: '32.836895', lng: '130.800143')
Venue.create(name: '大分スポーツ公園総合競技場', address: '〒870-0126 大分県大分市横尾１３５１', lat: '33.200716', lng: '131.657575')
...
Match.create!(country_id: '', opponent_id: '', venue_id: '4', pool: '３位決定戦', date: '11/1(金)', time: '18:00')
Match.create!(country_id: '', opponent_id: '', venue_id: '5', pool: '決勝', date: '11/2(土)', time: '18:00')